...
namespace FailsafeSystem
{
    ...
    public class Switch
    {
        ...
        public CoolantSystemStatus VerifyPrimaryCoolantSystem()
        {
            ...
            if (rand.Next(1, 20) > 18)
                throw new CoolantPressureReadException("Failed to read primary coolant system pressure");
        ...
        /// <returns>Coolant System Status (OK, Fail, Check)</returns>
        /// <exception cref="CoolantTemperatureReadException">Thrown when the
        /// switch cannot read the temperature from the backup coolant system</exception>
        /// <exception cref="CoolantPressureReadException">Thrown when the
        /// switch cannot read the pressure from the backup coolant system</exception>
        public CoolantSystemStatus VerifyBackupCoolantSystem()
        {
            ...
            if (rand.Next(1, 20) > 19)
                throw new CoolantPressureReadException("Failed to read backup coolant system pressure");
