...
namespace Task2._4
{
    public partial class MainWindow : Window
    {
        ...
        {
            if (matrix1Columns != null && matrix1Rows != null && grid1 != null) // Add grid1 != null check
            {
        ...
        {
            if (matrix2Columns != null && matrix1Columns != null && grid2 != null) // Check if grid2 is null
            {
                int rows = matrix1Columns.SelectedIndex + 1;
                int columns = matrix2Columns.SelectedIndex + 1;

                matrix2 = new Matrix(rows, columns);
                uiHandler.InitializeGrid(grid2, columns, rows); // Make sure grid2 is initialized
            }
        }
